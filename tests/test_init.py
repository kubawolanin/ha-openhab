...
from custom_components.openhab.const import DOMAIN
...
async def test_setup_unload_and_reload_entry(hass, bypass_get_data):
    ...
    # them to be. Because we have patched the OpenHABDataUpdateCoordinator.async_get_items
